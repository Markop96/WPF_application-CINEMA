...
namespace Bioskop.Forme
{
    public partial class formaRecenzija : Window
    {
        ...
        { 
            ...
            /*List<int> listaOcena = new List<int> //kreirana nova lista 
            {
                1, 2,3,4,5 //opcije, mozemo ih dodati koliko god zelimo

            };
            cbOcena.ItemsSource = listaOcena; //postavljamo listu kao izvor podataka (combobox obavezno na osnovu imena!)
            */
           
            List<string> listaOcena = new List<string> //kreirana nova lista 
            {
                "1", "2","3","4","5" //opcije, mozemo ih dodati koliko god zelimo
